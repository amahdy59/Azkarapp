...
- On compact screens the five post-prayer cards form a horizontal snap carousel with one full card and a visible next-card cue; tablet and desktop retain the multi-column grid. The Masbaha entry immediately follows this group in visual and DOM order. Summary and full variants preserve the same five-prayer DOM order and accessible prayer names.
