...
- The top session block combines one progress track with compact percentage and completed/total labels above it. A short, localized zikr title sits below the track and remains one line on compact screens; truncation preserves the full title through its accessible name/title.
