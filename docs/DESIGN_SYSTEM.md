...
- **A reviewed audio assignment remains actionable while the audio subsystem is preparing.** The first intentional press may wait for the lazy controller and then start; module loading itself must never autoplay or imply that an unreviewed recording exists.
