...
Current per-file production budgets are 550 KiB JavaScript, 120 KiB CSS, and 1 MiB for another asset. Reducing a budget is encouraged; increasing one requires measured justification in the pull request.
