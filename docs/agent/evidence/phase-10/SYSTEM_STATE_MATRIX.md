...
| ------------------------------------- | ----------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------ | ------------------------------------ | ---------------------------------------------------------- |
| Screen chunk                          | Visible text, spinner, `aria-busy`              | Screen renders                            | Retry, then Refresh app; Go to Azkar always available                                      | Only the requested screen            | Local state remains mounted and unchanged                  |
