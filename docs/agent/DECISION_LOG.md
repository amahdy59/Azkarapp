...
- **Decision:**
  ...
  - **The reading settings do not hide the page they change.** Theme, type size, and layout all act on what is behind the sheet, so this one surface drops the scrim's backdrop filter; every other modal keeps it.
