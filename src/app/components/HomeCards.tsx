...
export function PrayerRoutineCard({
  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col justify-between gap-5 rounded-[28px] border border-white/15 bg-on-media-surface/82 px-5 py-6 text-start shadow-raised backdrop-blur-lg sm:px-6 sm:py-7 md:p-7">
