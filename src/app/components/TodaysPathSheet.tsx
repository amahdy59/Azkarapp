  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3 px-5 py-4">
        ...
        <fieldset
          className={`rounded-2xl border p-3.5 ${onGlass ? "border-white/20 bg-white/10 text-white" : "border-border bg-card"}`}
        >
          <legend className={`px-1 text-label font-black ${onGlass ? "text-white" : "text-foreground"}`}>
            {t(language, "dailyPath.mosqueGoal")}
          </legend>
          ...
          <p className={`mt-2 text-xs font-semibold leading-5 ${onGlass ? "text-white/80" : "text-muted-foreground"}`}>
        ...
        <p
          className={`text-label font-bold ${onGlass ? "text-white" : "text-foreground"}`}
        ...
        <p className={`text-label font-semibold ${onGlass ? "text-white/80" : "text-muted-foreground"}`}>
          {status.palmEarned
