...
export function QuranHomeCard({
  ...
  if (!plan || !hasReadingActivity) {
    ...
    return (
      <div className="px-page mt-2 mb-2" dir={direction}>
        <div className="flex flex-col rounded-2xl bg-card border border-border p-4 shadow-raised">
          ...
          <div className="text-[0.875rem] font-medium text-muted-foreground mb-4" dir="auto">
        ...
        <div className="flex flex-col items-start p-4 text-start">
          <div className="flex items-center w-full gap-3 mb-3">
            ...
            <div className="flex-1">
              <div className="text-[0.8125rem] font-medium text-primary mb-0.5 uppercase tracking-wider" dir="auto">
