  ...
  return (
    <ScreenContainer dir={direction} className="px-0 relative" data-testid="friday-mode-screen">
      ...
      <div className="relative z-10 flex flex-1 flex-col gap-4 overflow-y-auto px-5 pb-8 pt-3">
        <section className="shrink-0 overflow-hidden rounded-[2rem] border border-amber-500/30 bg-gradient-to-br from-amber-500/15 to-card p-5 backdrop-blur-xl shadow-lg shadow-black/5">
        ...
        <section
          ...
          className="shrink-0 rounded-[2rem] border border-white/40 dark:border-white/10 bg-card p-5 backdrop-blur-xl shadow-lg shadow-black/5"
        >
        ...
        <button
          ...
          className="flex min-h-24 shrink-0 items-center gap-4 rounded-[2rem] border border-white/40 dark:border-white/10 bg-card p-5 text-start backdrop-blur-xl shadow-lg shadow-black/5 hover:border-amber-500/40 hover:shadow-xl transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring"
        >
        ...
        <button
          ...
          className="flex min-h-24 shrink-0 items-center gap-3 rounded-[2rem] border border-white/40 dark:border-white/10 bg-card p-5 text-start backdrop-blur-xl shadow-lg shadow-black/5 hover:border-amber-500/40 hover:shadow-xl transition-all focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring"
        >
