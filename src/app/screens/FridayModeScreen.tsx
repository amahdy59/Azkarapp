        ...
        <section aria-labelledby="comprehensive-duas-heading" className="space-y-4">
          <div className="rounded-3xl border border-amber-500/30 bg-amber-500/10 p-5 text-start">
            ...
            <button
              ...
              className="mt-4 min-h-11 w-full rounded-xl bg-amber-600 px-4 text-[0.875rem] font-black text-white shadow-sm focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring dark:bg-amber-500 dark:text-slate-950"
            >
