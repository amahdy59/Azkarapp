  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className={`${arabic ? "arabic-ui" : "latin-ui"} text-sm font-medium uppercase tracking-[0.56px] text-muted-foreground`}
          lang={arabic ? "ar" : "en"}
          dir={arabic ? "rtl" : "ltr"}
        >
      ...
      <div className="flex flex-col items-center gap-3 pb-14">
        ...
        <p className="text-micro font-medium text-muted-foreground">v2.0</p>
      </div>
    </div>
  );
}
