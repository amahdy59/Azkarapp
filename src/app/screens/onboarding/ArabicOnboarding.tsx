    ...
    <div className="flex items-center justify-between px-6 shrink-0 h-[44px] pt-[10px]">
      ...
      <div className="flex items-center gap-1.5">
        <svg width="17" height="12" viewBox="0 0 17 12" fill="none">
          {[0,1,2,3].map((i) => (
            <rect key={i} x={i * 4.5} y={12 - (3 + i * 3)} width="3" height={3 + i * 3} rx="0.5" fill="currentColor" className="text-foreground" opacity={i < 3 ? 1 : 1} />
          ))}
        </svg>
        <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
          <path d="M8 9.5L8 10.5" stroke="currentColor" className="text-foreground" strokeWidth="2" strokeLinecap="round"/>
          <path d="M5.5 7C6.3 6.2 7.1 5.8 8 5.8s1.7.4 2.5 1.2" stroke="currentColor" className="text-foreground" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
          <path d="M3 4.5C4.6 2.9 6.2 2 8 2s3.4.9 5 2.5" stroke="currentColor" className="text-foreground" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
        </svg>
...
export function ArFeatureRow({ text, colorClass }: { text: string; colorClass: string }) {
  return (
    <div className="flex items-center gap-3 w-full justify-end" dir="rtl">
      <p className="text-[14px] text-foreground leading-[22px] whitespace-nowrap" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
        {text}
      </p>
  ...
  return (
    <div className="flex items-center justify-center gap-2">
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} className={`rounded-full transition-all duration-300 ${i === active ? 'bg-primary' : 'bg-muted-foreground'}`}
          style={{
  ...
  return (
    <div className="flex flex-col h-full bg-background slide-in-from-right">
      ...
      <div className="relative shrink-0 flex items-center justify-center overflow-hidden h-[340px]">
        <div className="absolute w-[240px] h-[240px] rounded-full blur-[30px]" style={{
        ...
        <div className="absolute left-[80px] top-[100px]">
          <svg width="4" height="4" viewBox="0 0 4 4"><circle cx="2" cy="2" r="2" fill="currentColor" className="text-primary" /></svg>
        </div>
        <div className="absolute left-[300px] top-[150px]">
          <svg width="3" height="3" viewBox="0 0 3 3"><circle cx="1.5" cy="1.5" r="1.5" fill="currentColor" className="text-primary" /></svg>
        </div>
        <div className="absolute left-[240px] top-[60px]">
          <svg width="5" height="5" viewBox="0 0 5 5"><circle cx="2.5" cy="2.5" r="2.5" fill="currentColor" className="text-primary" /></svg>
        </div>

        <div className="absolute flex flex-col items-center gap-1 whitespace-nowrap bottom-[24px] left-1/2 -translate-x-1/2">
          <p className="text-[44px] font-extrabold text-foreground leading-normal tracking-[-0.88px]" style={{ fontFamily: "'Noto Naskh Arabic', 'Inter', sans-serif" }} dir="auto">
            أذكار
          </p>
      ...
      <div className="flex flex-col flex-1 px-7 justify-between pb-5">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3 items-center text-center" dir="rtl">
            <p className="text-[28px] font-bold text-foreground whitespace-nowrap leading-[40px]" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
              ذكرك الإسلامي اليومي
            </p>
            <div dir="auto" className="text-[14px] text-muted-foreground leading-[22px] text-center" style={{ fontFamily: "'Noto Naskh Arabic', serif" }}>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button onClick={onSkip}>
            <p className="text-[14px] font-semibold text-muted-foreground text-center w-full leading-[22px]" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
              تخطي
            </p>
          </button>
        </div>
      ...
      <div className="relative shrink-0 overflow-hidden h-[340px] bg-background">
        ...
        {[{ d: 190, op: 0.2 }, { d: 150, op: 0.3 }].map(({ d, op }, i) => (
          <div key={i} className="absolute left-0 top-0" style={{ width: d, height: d }}>
            <svg width={d} height={d} viewBox={`0 0 ${d} ${d}`} fill="none">
              <circle cx={d/2} cy={d/2} r={d/2 - 0.5} stroke="currentColor" className="text-primary" opacity={op} />
            </svg>
          </div>
        ))}
        ...
        <div className="absolute left-0 top-0 w-[120px] h-[120px]">
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" className="-rotate-90">
            ...
            <circle cx="60" cy="60" r={r} stroke="currentColor" className="text-primary" strokeWidth="8" fill="none"
        ...
        <div className="absolute flex flex-col items-center gap-0.5 whitespace-nowrap left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <p className="text-[9px] font-bold text-primary opacity-80 leading-[13px] tracking-[0.72px]" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
            انقر للعد
          </p>
          <p className="text-[56px] font-extrabold text-foreground leading-normal" style={{ fontFamily: "'Noto Naskh Arabic', 'Inter', sans-serif" }}>
            ٧
          </p>
          <p className="text-[14px] font-semibold text-primary leading-[22px]" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
            من ٣٣
          </p>
        </div>

        <p className="absolute right-[48px] top-1/2 text-[20px] font-bold text-[#24A08A] leading-normal" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
          +١
        </p>
      </div>
      ...
      <div className="flex flex-col flex-1 px-7 justify-between pb-5">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3 items-center text-center">
            <p className="text-[28px] font-bold text-foreground leading-[40px] whitespace-nowrap" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
              عدّ كل ذكر
            </p>
            <p className="text-[14px] text-muted-foreground leading-[22px] text-center" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
        ...
        <div className="flex flex-col gap-3">
          ...
          <button onClick={onBack}>
            <p className="text-[14px] font-semibold text-muted-foreground leading-[22px] text-center w-full" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
              رجوع
            </p>
          </button>
        </div>
      ...
      <div className="relative shrink-0 flex items-center justify-center overflow-hidden h-[340px] bg-background">
        <div className="absolute left-[20px] top-[80px]">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <line x1="12" y1="2" x2="12" y2="22" stroke="currentColor" className="text-primary" strokeWidth="2" strokeLinecap="round" />
            <line x1="2" y1="12" x2="22" y2="12" stroke="currentColor" className="text-primary" strokeWidth="2" strokeLinecap="round" />
            <line x1="4.9" y1="4.9" x2="19.1" y2="19.1" stroke="currentColor" className="text-primary" strokeWidth="2" strokeLinecap="round" />
            <line x1="19.1" y1="4.9" x2="4.9" y2="19.1" stroke="currentColor" className="text-primary" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
        ...
        <div className="relative flex items-end gap-1 w-[178px] h-[117px]">
          ...
          <div className="flex items-center justify-center rounded-sm px-2 shrink-0 w-[80px] h-[110px] bg-card border border-border origin-bottom rotate-5">
            <p className="text-center text-[14px] font-bold text-foreground leading-[22px] w-[60px]" dir="auto"
        ...
        <div className="absolute flex items-center px-3 py-1 rounded-full left-[20px] top-[258px] bg-[#24A08A] bg-opacity-20 border border-[#24A08A]">
          <p className="text-[10px] font-medium text-[#24A08A] leading-[14px] whitespace-nowrap" style={{ fontFamily: "'Noto Naskh Arabic', serif" }} dir="auto">
            حصن المسلم · موثق
          </p>
        </div>
      </div>
