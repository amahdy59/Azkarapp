  ...
  return (
    <PreAppLayout className="slide-in-from-right" contentClassName="pre-app-flow-centered relative">
      ...
      <div className="flex flex-col items-center gap-5 px-6 pb-7 pt-4">
        <h1 className="text-center text-display font-extrabold leading-9 tracking-[-0.28px] text-foreground">
        ...
        <button
          ...
          onClick={onNext}
          className="h-[52px] w-full rounded-2xl border-2 border-white/10 bg-primary text-title font-bold text-primary-foreground shadow-[inset_0_-2px_0_rgba(10,13,18,0.12)] transition-transform"
        >
