const en = {
  ...
  benefits: {
    title: "Zikr Benefits",
    subtitle: "Reviewed benefits and their sources",
    homeDescription: "Browse benefits already reviewed in the app, with the cited source beside each one.",
    open: "Explore benefits",
    reviewedHeading: "Reviewed content",
    reviewedDescription:
      "These entries reuse the app’s reviewed benefit and source fields; no new religious claims are generated here.",
