const en = {
  ...
  garden: {
    ...
    adherence: "Adherence",
    fullPalms: "Full Palms 🌴",
    totalLeavesEarned: "Total: {count} leaves earned",
    yearlyOasisMap: "Yearly Oasis Map",
    weeklyRecord: "Weekly Record",
  },
  shareModal: {
    dialogAria: "Share Achievement Card",
  ...
  auth: {
    ...
    mergeGuestProgress:
      "Add this device's guest progress and saved azkar to this account? Select Skip to keep the account history separate.",
    mergeTitle: "Merge Progress",
