...
const ARABIC_BENEFITS_BY_ID: Readonly<Record<string, string>> = {
  "m-hm-75": "حفظ من الجن بإذن الله حتى المساء.",
  "e-hm-75": "حفظ من الجن بإذن الله حتى الصباح.",
  "m-hm-79": "من قاله موقنًا به ثم مات في يومه كان من أهل الجنة.",
  "e-hm-79": "من قاله موقنًا به ثم مات في ليلته كان من أهل الجنة.",
  "m-hm-82": "دعاء نبوي لعافية البدن والسمع والبصر، يقال ثلاث مرات.",
  "e-hm-82": "دعاء نبوي لعافية البدن والسمع والبصر، يقال ثلاث مرات.",
  "m-hm-83": "إعلان قرآني موجز للتوكل على الله وحده.",
  "e-hm-83": "إعلان قرآني موجز للتوكل على الله وحده.",
  "m-hm-84": "سؤال جامع للعفو والعافية والحفظ.",
  "e-hm-84": "سؤال جامع للعفو والعافية والحفظ.",
  "m-hm-86": "يقال ثلاث مرات؛ فلا يضره شيء بإذن الله.",
  "e-hm-86": "يقال ثلاث مرات؛ فلا يضره شيء بإذن الله.",
  "m-hm-87": "يقال ثلاث مرات إقرارًا بالرضا بالله والإسلام ومحمد ﷺ.",
  "e-hm-87": "يقال ثلاث مرات إقرارًا بالرضا بالله والإسلام ومحمد ﷺ.",
  "m-hm-88": "استغاثة بالله لإصلاح الشأن كله وألا يكل العبد إلى نفسه.",
  "e-hm-88": "استغاثة بالله لإصلاح الشأن كله وألا يكل العبد إلى نفسه.",
  "m-hm-91": "يقال مائة مرة؛ فتحط الخطايا وإن كانت مثل زبد البحر.",
  "e-hm-91": "يقال مائة مرة؛ فتحط الخطايا وإن كانت مثل زبد البحر.",
  "m-hm-94": "ثلاث مرات تعدل ذكرًا طويلًا من أول النهار.",
  "m-hm-95": "سؤال بعد الفجر للعلم النافع والرزق الطيب والعمل المتقبل.",
  "m-hm-97": "يقال ثلاث مرات مساءً للحفظ من السم في تلك الليلة.",
  "e-hm-97": "يقال ثلاث مرات مساءً للحفظ من السم في تلك الليلة.",
  "e-hm-77e": "كان النبي ﷺ يقول هذا الذكر إذا أمسى.",
  "e-hm-78e": "ذكر نبوي يقر بأن الحياة والموت والمصير إلى الله.",
  "e-hm-80e": "يقال أربع مرات مساءً؛ وقد ورد أنه سبب للعتق من النار.",
  "e-hm-81e": "يقال مساءً شكرًا لنعم الليل.",
  "e-hm-89e": "سؤال جامع لخير الليلة والاستعاذة من شرها.",
  "e-hm-90e": "شهادة مسائية بالإيمان بالله ودين الإسلام.",
  "m-hm-98": "عشر صلوات على النبي ﷺ صباحًا؛ ورد أنها سبب لنيل شفاعته.",
  "e-hm-98": "عشر صلوات على النبي ﷺ مساءً؛ ورد أنها سبب لنيل شفاعته.",
  "da-ref-5": "إعلان قرآني بأن الله وحده الكافي والمستحق للتوكل.",
  "ne-ref-6": "الهدي الصحيح عند الكسوف: الدعاء والتكبير والصلاة والصدقة.",
  "s-hm-110a": "وردت قراءة السجدة والملك قبل النوم، وقد اختلف العلماء في درجة الحديث.",
  "s-hm-110b": "تشفع هذه السورة ذات الثلاثين آية لصاحبها حتى يغفر له.",
};
