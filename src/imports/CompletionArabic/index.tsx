...
import svgPaths from "./svg-yqv9sh9623";
...
function HeaderLabel() {
  return (
    <div className="content-stretch flex flex-col items-center pt-[20px] relative shrink-0 w-full" data-name="header-label">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap" dir="auto">
        جلسة الصباح مكتملة
      </p>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="congrats-text">
      <div className="flex flex-col items-center size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-center not-italic px-[40px] relative size-full text-center">
          <p className="font-['Inter:Extra_Bold','Noto_Sans_Arabic:Black',sans-serif] font-extrabold leading-[36px] relative shrink-0 text-[#c8941a] text-[28px] tracking-[-0.28px] whitespace-nowrap" dir="auto">
            ما شاء الله!
          </p>
          <p className="font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] min-w-full relative shrink-0 text-[#0a1228] text-[17px] w-[min-content]" dir="auto">
            لقد أتممت أذكار الصباح
          </p>
          <p className="font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[#94a3b8] text-[13px] w-[min-content]" dir="auto">
            كل ذكر نور في قلبك
          </p>
        </div>
      </div>
  ...
  return (
    <div className="bg-[#111b35] flex-[1_0_0] min-w-px relative rounded-[20px]" data-name="stat-card">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start not-italic p-[20px] relative size-full whitespace-nowrap">
        <p className="font-['Inter:Extra_Bold','Noto_Sans_Arabic:Black',sans-serif] font-extrabold leading-[36px] relative shrink-0 text-[#c8941a] text-[28px] tracking-[-0.28px]">١٥</p>
        <p className="font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] opacity-70 relative shrink-0 text-[#94a3b8] text-[14px]" dir="auto">
          الأذكار
        </p>
      </div>
    </div>
...
function StatsRow1() {
  return (
    <div className="relative shrink-0 w-full" data-name="stats-row-2">
      <div className="content-stretch flex gap-[16px] items-start px-[24px] relative size-full">
        <StatCard2 />
        <StatCard3 />
      </div>
...
function CelebrationCenter() {
  return (
    <motion.div className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-full" data-name="celebration-center">
      ...
      <StatsRow />
      <StatsRow1 />
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] not-italic opacity-60 relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap" dir="auto">
        الأربعاء · ٢ يوليو ٢٠٢٦
      </p>
    </motion.div>
  );
}
...
function ShareBtn() {
  return (
    <div className="content-stretch flex gap-[10px] h-[56px] items-center justify-center relative rounded-[16px] shrink-0 w-full" data-name="share-btn">
      ...
      <Share />
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#c8941a] text-[17px] whitespace-nowrap" dir="auto">
        مشاركة التقدم
      </p>
    </div>
  );
    ...
    <motion.div className="relative shrink-0 w-full" data-name="action-section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-center pb-[40px] px-[24px] relative size-full">
          <ShareBtn />
          <HomeBtn />
          <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] not-italic opacity-80 relative shrink-0 text-[#94a3b8] text-[14px] whitespace-nowrap" dir="auto">
            عد عند الغروب لأذكار المساء
          </p>
          <HomeIndicator />
        </div>
      </div>
...
function Bookmark() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="bookmark">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="bookmark">
          <path d={svgPaths.p24c8ac0} id="Vector" stroke="var(--stroke-0, #9290B0)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function NavItemAzkar() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-center justify-center relative shrink-0" data-name="nav-item-azkar">
      <Bookmark />
      <p className="[word-break:break-word] font-['Inter:Medium','Noto_Sans_Arabic:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#9290b0] text-[11px] whitespace-nowrap" dir="auto">
        الأذكار
      </p>
...
export default function CompletionArabic() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start justify-between relative size-full" data-name="Completion - Arabic">
      <TopSection />
      <CelebrationCenter />
      <ActionSection />
      <BottomNav />
