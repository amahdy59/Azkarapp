...
import svgPaths from "./svg-8dpcbi7cgy";
...
function ScreenHeader() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[4px] items-start leading-[22px] relative shrink-0 text-[14px] w-full" data-name="screen-header">
      <p className="relative shrink-0 text-[#9290b0] w-full">{`Allahumma inni as'alukal-afwa wal-afiyah`}</p>
      <p className="relative shrink-0 text-[#f5f0e8] w-full">O Allah, I ask You for forgiveness and well-being in this world and the hereafter.</p>
    </div>
  );
}
...
function ArabicCard() {
  return (
    <div className="bg-[#111b35] relative shrink-0 w-full" data-name="arabic-card">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start not-italic p-[24px] relative size-full">
        <p className="font-['Inter:Bold','Noto_Sans_Arabic:Bold',sans-serif] font-bold leading-[30px] relative shrink-0 text-[#f5f0e8] text-[22px] text-right tracking-[-0.11px] w-full" dir="auto">
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Frame">
      <Icon />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f5f0e8] text-[13px] whitespace-nowrap">{`Benefit & Virtue`}</p>
    </div>
  );
}
    ...
    <div className="bg-[#1a7060] h-[52px] relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[24px] relative size-full">
          <Icon2 />
          <Frame3 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#f5f0e8] text-[14px] whitespace-nowrap">1×</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="absolute bottom-[48px] content-stretch flex flex-col gap-[12px] items-center left-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] text-center whitespace-pre">{`Hold 2s to reset  ·  Swipe → for next`}</p>
...
export default function CounterDuringZikr() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start relative size-full" data-name="Counter During Zikr">
      <StatusBar />
      <TopSection />
      <CounterZone />
    </div>
