...
import svgPaths from "./svg-fnacmf6vxn";
    ...
    <div className="h-[56px] relative shrink-0 w-full" data-name="header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[16px] relative size-full">
          <BackBtn />
          <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#f5f0e8] text-[17px] text-center whitespace-nowrap" dir="auto">
            الإعدادات
          </p>
          <RightAction />
        </div>
...
function SectionLabel() {
  return (
    <div className="content-stretch flex items-start pb-[8px] pl-[16px] pt-[24px] relative shrink-0" data-name="section-label">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#c8941a] text-[11px] whitespace-nowrap" dir="auto">
        التفضيلات
      </p>
    </div>
  );
...
function RightSide() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="right-side">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#9290b0] text-[14px] whitespace-nowrap" dir="auto">
        العربية
      </p>
      <ChevronRight />
    </div>
    ...
    <div className="bg-[#111b35] h-[56px] relative shrink-0 w-full" data-name="settings-row">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[16px] relative size-full">
          <IconBg />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] min-w-px not-italic relative text-[#f5f0e8] text-[17px] text-right" dir="auto">
            اللغة
          </p>
          <RightSide />
        </div>
  ...
  return (
    <div className="bg-[#111b35] h-[56px] relative shrink-0 w-full" data-name="settings-row">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center px-[16px] relative size-full">
          <IconBg10 />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] min-w-px not-italic relative text-[#c0392b] text-[17px] text-right" dir="auto">
            تسجيل الخروج
          </p>
          <RightSide10 />
        </div>
...
function Footer() {
  return (
    <div className="content-stretch flex flex-col items-center py-[40px] relative shrink-0 w-full" data-name="footer">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#9290b0] text-[13px] whitespace-nowrap" dir="auto">
        أذكار الإصدار ٢.٠.١
      </p>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[22px]" data-name="settings">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="settings">
          <path d={svgPaths.p3223ce70} id="Vector" stroke="var(--stroke-0, #C8941A)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function NavSettingsActive() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0" data-name="nav-settings-active">
      <Settings />
...
function CircleX() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="circle-x">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g clipPath="url(#clip0_11_6281)" id="circle-x">
          <path d={svgPaths.p2e607180} id="Vector" stroke="var(--stroke-0, #9290B0)" strokeLinecap="round" strokeWidth="2" />
        </g>
        <defs>
          <clipPath id="clip0_11_6281">
...
function NavAzkar() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0" data-name="nav-azkar">
      <CircleX />
...
export default function SettingsArabic() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start relative size-full" data-name="Settings - Arabic">
      <MainContent />
      <IndicatorArea />
      <BottomNav />
    </div>
