import svgPaths from "./svg-nnvt1ujppj";
...
function Frame1() {
  return (
    <div className="bg-[#c8941a] content-stretch flex flex-col items-center justify-center px-[12px] py-[6px] relative rounded-[100px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#f5f0e8] text-[14px] whitespace-nowrap">Progress: 4 of 15</p>
    </div>
  );
}
...
function ScreenHeader1() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[12px] items-start leading-[24px] relative shrink-0 text-[17px] w-full" data-name="screen-header">
...
function CategoryCard() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[24px] items-center not-italic relative shrink-0 text-center w-full" data-name="category-card">
      <p className="font-['Inter:Extra_Bold','Noto_Sans_Arabic:Black',sans-serif] font-extrabold leading-[36px] relative shrink-0 text-[#f5f0e8] text-[28px] tracking-[-0.28px] w-full" dir="auto">
...
function BtnPrimary() {
  return (
    <div className="bg-[#111b35] h-[44px] relative rounded-[12px] shrink-0 w-full" data-name="btn-primary">
...
function Frame4() {
  return (
    <div className="bg-[#1a7060] content-stretch flex items-start px-[10px] py-[4px] relative rounded-[10px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#1a7060] text-[14px] whitespace-nowrap">1×</p>
    </div>
  );
}
...
function CounterZone() {
  return (
    <div className="bg-[#111b35] content-stretch flex flex-col h-[321px] items-center justify-between pt-[20px] relative rounded-tl-[40px] rounded-tr-[40px] shrink-0 w-full" data-name="counter-zone">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#9290b0] text-[11px] whitespace-nowrap">Tap anywhere to count</p>
      <RingContainer />
...
export default function ZikrReader() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start relative size-full" data-name="Zikr Reader">
      <StatusBar />
      <ScreenHeader />
      <Frame2 />
      <CounterZone />
