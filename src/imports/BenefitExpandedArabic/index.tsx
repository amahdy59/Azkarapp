...
import svgPaths from "./svg-6yn85m5ov2";
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Frame">
      <Icon />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#f5f0e8] text-[14px] whitespace-nowrap">{`Benefit & Virtue`}</p>
    </div>
  );
}
...
function StatusBar1() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="status-bar">
...
function Frame4() {
  return (
    <div className="bg-[#1a7060] content-stretch flex items-start px-[10px] py-[4px] relative rounded-[6px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Medium','Noto_Sans_Arabic:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#f5f0e8] text-[10px] whitespace-nowrap" dir="auto">
        أجر عظيم ⭐
      </p>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[24px] px-[24px] relative size-full">
        <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[20px] min-w-full not-italic relative shrink-0 text-[#f5f0e8] text-[13px] text-right w-[min-content]" dir="auto">
...
function Icon3() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex items-start left-[calc(50%+60px)] opacity-80 top-[calc(50%-60px)]" data-name="icon">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#1a7060] text-[17px] whitespace-nowrap" dir="auto">
        +١
      </p>
    </div>
  );
...
function Frame8() {
  return (
    <div className="absolute bottom-[48px] content-stretch flex flex-col gap-[12px] items-center left-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] text-center whitespace-nowrap">Hold 2s to reset · Swipe → for next</p>
...
function CounterZone() {
  return (
    <motion.div className="bg-[#0d1530] flex-[1_0_0] min-h-px relative w-full" data-name="counter-zone">
  ...
  return (
    <div className="relative shrink-0 size-[22px]" data-name="home">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="home">
          <path d={svgPaths.p1e6ad500} id="Vector" stroke="var(--stroke-0, #9290B0)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function NavHome() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0" data-name="nav-home">
      <Home />
...
function CircleX() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="circle-x">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g clipPath="url(#clip0_11_6244)" id="circle-x">
          <path d={svgPaths.p2e607180} id="Vector" stroke="var(--stroke-0, #C8941A)" strokeLinecap="round" strokeWidth="2" />
        </g>
        <defs>
          <clipPath id="clip0_11_6244">
...
function NavAzkarActive() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0" data-name="nav-azkar-active">
      <CircleX />
      <p className="[word-break:break-word] font-['Inter:Medium','Noto_Sans_Arabic:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#c8941a] text-[10px] whitespace-nowrap" dir="auto">
        الأذكار
      </p>
...
function Settings() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="settings">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="settings">
          <path d={svgPaths.p3223ce70} id="Vector" stroke="var(--stroke-0, #9290B0)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function NavSettings() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center justify-center relative shrink-0" data-name="nav-settings">
      <Settings />
      <p className="[word-break:break-word] font-['Inter:Medium','Noto_Sans_Arabic:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] whitespace-nowrap" dir="auto">
        الإعدادات
      </p>
...
function BottomNav() {
  return (
    <div className="bg-[#111b35] h-[72px] relative shrink-0 w-full" data-name="bottom-nav">
...
export default function BenefitExpandedArabic() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start relative size-full" data-name="Benefit Expanded - Arabic">
      <StatusBar />
      <TopPortion />
      <BenefitExpanded />
      <Frame5 />
