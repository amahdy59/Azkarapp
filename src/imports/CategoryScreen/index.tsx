...
import svgPaths from "./svg-dtmf5tipjm";
    ...
    <div className="relative shrink-0 w-full" data-name="screen-header">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[16px] py-[12px] relative size-full">
          <Icon />
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] min-w-px not-italic relative text-[#f5f0e8] text-[17px] text-center">Morning Azkar</p>
          <Icon1 />
        </div>
      </div>
    </div>
...
function Frame3() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Frame">
      <p className="font-['Inter:Extra_Bold',sans-serif] font-extrabold leading-[36px] relative shrink-0 text-[#c8941a] text-[28px] tracking-[-0.28px]">12 / 15</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#9290b0] text-[14px]">12 of 15 complete</p>
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#9290b0] text-[17px] text-ellipsis whitespace-nowrap">Al-Fatihah</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#9290b0] text-[17px] text-ellipsis whitespace-nowrap">Ayat al-Kursi</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#9290b0] text-[17px] text-ellipsis whitespace-nowrap">Al-Ikhlas</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#f5f0e8] text-[17px] text-ellipsis whitespace-nowrap">Al-Falaq</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="bg-[#1a7060] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#111b35] text-[14px] whitespace-nowrap">×3</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#f5f0e8] text-[17px] text-ellipsis whitespace-nowrap">An-Nas</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#f5f0e8] text-[17px] text-ellipsis whitespace-nowrap">Morning Supplication</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="bg-[#1a7060] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#111b35] text-[14px] whitespace-nowrap">×1</p>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic overflow-hidden relative shrink-0 text-[#f5f0e8] text-[17px] text-ellipsis whitespace-nowrap">Istighfar</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="bg-[#1a7060] content-stretch flex items-start px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#111b35] text-[14px] whitespace-nowrap">×33</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] whitespace-nowrap">Completed</p>
      <ZikrItem />
      <ZikrItem1 />
      <ZikrItem2 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] whitespace-nowrap">Remaining</p>
      <ZikrItem3 />
      <ZikrItem4 />
      <ZikrItem5 />
      <ZikrItem6 />
...
function BtnPrimary() {
  return (
    <div className="bg-[#c8941a] content-stretch flex h-[56px] items-center justify-center relative rounded-[16px] shrink-0 w-full" data-name="btn-primary">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#0a1228] text-[17px] whitespace-nowrap">Resume Session</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="category-card">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center p-[20px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] whitespace-nowrap">4 remaining</p>
          <BtnPrimary />
        </div>
      </div>
    </div>
...
function TabHome() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0 w-[130px]" data-name="tab-home">
      <IconWrapper4 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] whitespace-nowrap">Home</p>
    </div>
  );
}
...
function TabAzkar() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0 w-[130px]" data-name="tab-azkar">
      <ActivePill />
      <IconWrapper5 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#c8941a] text-[10px] whitespace-nowrap">Azkar</p>
    </div>
  );
}
...
export default function CategoryScreen() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start justify-between relative size-full" data-name="Category Screen">
      <Frame />
      <Frame16 />
    </div>
  );
