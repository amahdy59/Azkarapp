...
import svgPaths from "./svg-veoyr45yuy";
...
function BtnPrimary() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] items-end not-italic relative shrink-0 text-right whitespace-nowrap" data-name="btn-primary">
      ...
      <p className="font-['Inter:Bold','Noto_Sans_Arabic:Bold',sans-serif] font-bold leading-[30px] relative shrink-0 text-[#f5f0e8] text-[22px] tracking-[-0.11px]" dir="auto">
        وعليكم السلام
      </p>
    </div>
  );
...
function Frame4() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-end not-italic relative shrink-0 text-right whitespace-nowrap" data-name="Frame">
      <p className="font-['Inter:Semi_Bold','Noto_Sans_Arabic:SemiBold',sans-serif] font-semibold leading-[24px] relative shrink-0 text-[#f5f0e8] text-[17px]" dir="auto">
        أذكار الصباح
      </p>
      <p className="font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#9290b0] text-[14px]" dir="auto">
        ١٢ من ١٥ مكتملة
...
function Frame6() {
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal items-start justify-between leading-[22px] not-italic relative shrink-0 text-[#9290b0] text-[14px] w-full whitespace-nowrap" data-name="Frame">
      <p className="relative shrink-0 text-right" dir="auto">
        ١٢ من ١٥ مكتملة
      </p>
...
function BookOpen() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="book-open">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="book-open">
          <path d={svgPaths.p17021320} id="icon" stroke="var(--stroke-0, #C8941A)" strokeLinecap="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Home() {
  return (
    <div className="relative shrink-0 size-[22px]" data-name="home">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
        <g id="home">
          <path d={svgPaths.p36edb400} id="icon" stroke="var(--stroke-0, #9290B0)" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
export default function HomeArabicRtl() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start justify-between relative size-full" data-name="Home - Arabic RTL">
      <Frame />
      <BottomNav />
    </div>
  );
