...
import svgPaths from "./svg-jl8dtxp2oz";
...
function StatusBar() {
  return (
    <motion.div className="h-[44px] relative shrink-0 w-full" data-name="status-bar">
...
function ScreenHeader() {
  return (
    <div className="content-stretch flex flex-col font-normal gap-[4px] items-start leading-[22px] relative shrink-0 text-[14px] w-full" data-name="screen-header">
      <p className="font-['Inter:Regular',sans-serif] relative shrink-0 text-[#9290b0] w-full">{`Allāhumma innī as'aluka al-ʿafwa wal-ʿāfiyah`}</p>
      <p className="font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] relative shrink-0 text-[#f5f0e8] w-full" dir="auto">
...
function ArabicCard() {
  return (
    <div className="bg-[#111b35] relative shrink-0 w-full" data-name="arabic-card">
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start not-italic p-[24px] relative size-full text-right">
        <p className="font-['Inter:Bold','Noto_Sans_Arabic:Bold',sans-serif] font-bold leading-[30px] relative shrink-0 text-[#f5f0e8] text-[22px] tracking-[-0.11px] w-full" dir="auto">
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_Arabic:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#f5f0e8] text-[13px] whitespace-nowrap" dir="auto">
        الفائدة والفضيلة
      </p>
      <Icon1 />
    </div>
...
function Frame() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Frame">
      <div aria-hidden className="absolute border-[#182540] border-b border-solid border-t inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[24px] relative size-full">
          <Icon />
          <Frame1 />
...
function TopSection() {
  return (
    <motion.div className="content-stretch flex flex-col h-[380px] items-start relative shrink-0 w-full" data-name="top-section">
      <Header />
      <ArabicCard />
      <Frame />
      <Frame2 />
...
function Frame5() {
  return (
    <div className="absolute bottom-[48px] content-stretch flex flex-col gap-[12px] items-center left-0" data-name="Frame">
      <p className="[word-break:break-word] font-['Inter:Medium','Noto_Sans_Arabic:Medium',sans-serif] font-medium leading-[14px] not-italic relative shrink-0 text-[#9290b0] text-[10px] text-center whitespace-nowrap" dir="auto">
        اضغط مطولاً للإعادة · اسحب للتالي
      </p>
    ...
    <motion.div className="bg-[#0d1530] flex-[1_0_0] min-h-px relative w-full" data-name="counter-zone">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center pt-[32px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Bold','Noto_Sans_Arabic:Bold',sans-serif] font-bold leading-[13px] not-italic relative shrink-0 text-[#c8941a] text-[9px] tracking-[0.72px] whitespace-nowrap" dir="auto">
...
export default function CounterArabic() {
  return (
    <div className="bg-[#0a1228] content-stretch flex flex-col items-start relative size-full" data-name="Counter - Arabic">
      <StatusBar />
      <TopSection />
      <CounterZone />
      <BottomNav />
